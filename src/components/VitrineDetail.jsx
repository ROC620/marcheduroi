    ...
    <div style={{ background: structure.bg_image ? `linear-gradient(${VT.bg}CC,${VT.bg}CC), url(${structure.bg_image}) center/cover fixed` : VT.bg, minHeight:"100vh",fontFamily:"Sora,sans-serif",color:VT.text }}>
      ...
      <div style={{ maxWidth:750,margin:"0 auto",padding:`0 24px 48px` }}>
        ...
        <div style={{ display:"flex",gap:10,marginBottom:24,flexWrap:"wrap" }}>
          {/* WhatsApp — texte seul, pas d'URL visible */}
          <a href={"https://wa.me/?text="+encodeURIComponent(`${structure.name} est sur MarchéduRoi 👑\nhttps://marcheduroi.com/api/vitrine-og?slug=${slug}`)}
            target="_blank" rel="noopener noreferrer"
            style={{ flex:1,display:"flex",alignItems:"center",justifyContent:"center",gap:6,background:"rgba(37,211,102,0.1)",border:"1px solid rgba(37,211,102,0.3)",borderRadius:12,padding:12,color:"#25D366",textDecoration:"none",fontWeight:700,fontSize:14,minWidth:100 }}>
