  ...
  <div style={{ width:"100%",maxWidth:700,margin:"0 auto",padding:"48px 40px",animation:"fadeIn 0.4s ease" }}>
    ...
    {user ? (
      <div style={{ ...cardStyle,borderRadius:20,padding:32 }}>
        ...
        <a href={`https://wa.me/?text=${encodeURIComponent("🛍️ Rejoins-moi sur MarchéduRoi, la plateforme multipolaire pour booster ton business ! 👑\nInscris-toi ici 👉 https://marcheduroi.com?ref="+user.id)}`} target="_blank" rel="noopener noreferrer" style={{ textDecoration:"none",display:"block" }}>
